    ...
    return (
        <div className="min-h-screen flex">
            ...
            <div className="w-1/4 bg-transparent p-6 pt-16"> {/* Added pt-32 to push the left column below the navbar */}
                {isLoggedIn ? (
                    <div>
                        <h2 className="text-2xl font-bold mb-4">Your Math Stats</h2>
                        <ul>
                            <li>Exams Taken: 5</li>
            ...
            <div className="w-3/4 p-8 pt-48"> {/* Keeping pt-32 to match the shift of main content down */}
                <h1 className="text-7xl font-bold mb-8">Mathematics</h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-16">
                    ...
                    <Link
                        ...
                        state={{ from: '/mathematics' }} // Passing the current page as state
                    ...
                    >
                        ...
                        <p>Download previous math exams for offline practice.</p>
                    </Link>
                    ...
                    >
                        ...
                        <p>Find additional materials to help you ace your math exam.</p>
                    </Link>
                </div>
            </div>
        </div>
